...
const clientId = 'c7ca52a0-46ff-4603-8100-8f17c532d094'
const tenantName = 'urlshortenerorg'

const flows = {
  localAccSignInSignUp: 'B2C_1_main_flow', // e.g., B2C_1_main_flow
  msid: 'B2C_1_msid'
}

const activeFlow = flows.localAccSignInSignUp
...
export const msalConfig = {
  auth: {
    ...
    postLogoutRedirectUri: 'https://localhost:3000/logout', // Indicates the page to navigate after logout.
